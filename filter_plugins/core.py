...
def chart_values_to_argo_parameters(dictionary, force_string_dict={}, prune_none_value_flag=True, n=8, prefix_str=" "):
    data = {}
...
def __prune_none_value_with_pathes(_dict, preserve_existing_empty_dict=False):
    ...
    if isinstance(_dict, dict):
        for key, value in list(_dict.items()):
            ...
            if preserve_existing_empty_dict and isinstance(value, dict) and len(value) == 0: 
                continue
